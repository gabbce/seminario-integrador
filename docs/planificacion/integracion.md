...
El [plan detallado de I-01](i-01-base-e-ingreso.md) está aprobado: alcance, proyecto Supabase, preparación de cuentas, contrato de sesión, cuatro subcortes y validación. I-01 implementada y verificada; ver [avance y evidencia](avance-i-01.md). I-02 está implementada y aceptada, incluidos los ajustes visuales. El [plan detallado de I-03](i-03-reserva-periodica.md) fue aprobado secuencialmente el 17/09/2026 y está implementado, verificado y aceptado por el usuario el 17/09/2026; ver [avance y evidencia](avance-i-03.md). I-04 a I-06 pendientes de sus planes detallados. No construir avisos temporales de módulos sin integrar; conectar el acceso sobre la interfaz existente.
