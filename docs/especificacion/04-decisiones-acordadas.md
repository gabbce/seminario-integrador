...
| DA-25 | Periódicas: elegir una sola aula por día semanal, disponible en todas sus fechas efectivas del período. Esporádicas: aula por fecha. | No combinar aulas entre fechas del mismo patrón. Cambio de aula periódico abarca todas sus futuras vigentes, conservando historial. |
...
| DA-28 | Sin aula disponible para una periódica, priorizar alternativas con solo conflictos esporádicos por menos fechas afectadas y luego minutos; después, conflictos periódicos por menos minutos acumulados y luego fechas esporádicas afectadas. | Alternativas informativas con reservas y responsables/contactos para Admin/Bedel; sin confirmación hasta resolver. Desempatar por capacidad e identificador. Esporádicas conservan orden por minutos. |
...
| DA-57 | Las nuevas ocurrencias por calendario usan el aula asignada al patrón semanal. | Revisar y guardar calendario/ocurrencias juntos; si hay conflicto, resolverlo o reasignar todas las futuras del patrón antes de reintentar. Sin aula por fecha nueva. |
