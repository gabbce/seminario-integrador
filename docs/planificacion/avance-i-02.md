...
## Aceptación manual y ajustes visuales · 17/09/2026

El usuario completó el QA y aceptó la operación funcional de I-02. Solicitó mejorar la separación de alertas rojas y la presentación del calendario académico. Se ajustaron márgenes/relleno de alertas, panel de configuración del año, distribución de cuatrimestres/fechas, acciones y adaptación móvil. Al verificar se corrigió también una recarga de referencias innecesaria que desmontaba el editor y podía hacer desaparecer la confirmación de guardado: los cursos se recargan al cambiar el conjunto de años, no por editar fechas o estado. La revisión visual del usuario de estos ajustes permanece abierta.
